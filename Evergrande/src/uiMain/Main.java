		...
		switch (table) {
			case "citas_1":
				for (int idInmuebleCita : inmueblesCitas) {
					citasCount++;
					System.out.println("\nCita n�mero " + citasCount);
					System.out.format("+-------------+-----------------+-------------------+%n");
					System.out.format("| ID INMUEBLE | NOMBRE INMUEBLE |     DIRECCI�N     |%n");
					System.out.format("+-------------+-----------------+-------------------+%n");
					...
					System.out.format("+-------------+-----------------+-------------------+%n");
					System.out.format("+---------+-----+-----+-----+------+---------------+%n");
					System.out.format("| ID CITA | DIA | MES | A�O | HORA | NOMBRE AGENTE |%n");
					System.out.format("+---------+-----+-----+-----+------+---------------+%n");
	...
	public static void printAgentesTable(ArrayList<Agente> agentes , String table) {
		...
		case "agentes_1":
			...
			for (Agente agente: agentes) {
				agenteCount++;
				System.out.println("Agente n�mero " + agenteCount);
				System.out.format("+------------+----------------------+------------------+---------------+----------+----------------+%n");
        ...
        do {
            ...
            switch (opt1) {
                ...
                case 6:
                	...
                	System.out.print("\nIngrese el dia en el que desea la cita (ingrese -1 para volver atr�s): ");
                	diaCita = sc.nextInt();
                	if (diaCita == -1) {break;}
                	...
                	System.out.print("Ingrese el a�o en el que desea la cita: ");
                	anoCita = sc.nextInt();
                	...
                	if (!(agentesDisponiblesIDS.contains(idAgenteCita))) {
                		System.out.println("\nNo hay agentes disponibles con la c�dula ingresada!");
                		break;
                	}
                ...
                case 8:
                	...
                	printCitasTable(citasCliente, "citas_1");
                	System.out.print("\nIngrese el ID de la cita a cancelar (ingrese -1 para volver atr�s): ");
